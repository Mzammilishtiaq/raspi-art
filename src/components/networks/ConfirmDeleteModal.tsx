...
export const ConfirmDeleteModal = ({ network, opened, loading, close, onConfirmDelete }: ConfirmDeleteModelProps) => (
  <Modal size='md' opened={opened} onClose={close} title='Delete Network?'>
    <Box pos='relative'>
      <LoadingOverlay
        visible={loading}
        zIndex={1000}
      ...
      <Stack>
        <Text>
          Are you sure you want to delete <b>{network.label}</b>?
        </Text>
